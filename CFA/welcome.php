        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="assets/img/logo1.png" alt="Logo" width="100" height="100">
                </a>
...
-->
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="assets/img/Efrat.JPG" width="31"
                                alt="Efrat">
                            <div class="user-text">
                                <h6>Efrat</h6>
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a href="club-dashboard.html">Club Dashboard</a></li>
                                <li><a href="member-dashboard.html">Member Dashboard</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fas fa-graduation-cap"></i> <span>Members</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="member-list.html">Member List</a></li>
                                <li><a href="member-details.html">Member View</a></li>
                                <li><a href="add-member.html">Member Add</a></li>
                                <li><a href="edit-member.html">Member Edit</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span>Clubs</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="clubs.html">Club List</a></li>
                                <li><a href="club-details.html">Club View</a></li>
                                <li><a href="add-clubs.html">Club Add</a></li>
                                <li><a href="edit-club.html">Club Edit</a></li>
                            </ul>
                        </li>
                        <!-- <li class="submenu">
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-file-invoice-dollar"></i> <span> Accounts</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="reg-fee.html">Registration Collection</a></li>
                                <li><a href="expenses.html">Expenses</a></li>
                                <!--<li><a href="salary.html">Salary</a></li>-->
                                <li><a href="add-reg-fees.html">Add Fees</a></li>
                       ...
                       <!-- <li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><i class="fas fa-code"></i> 
                                <span>Multi Level</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li class="submenu">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6">
                                        <ul class="chart-list-out">
                                            <li><span class="circle-blue"></span>Student</li>
                                            <li><span class="circle-green"></span>Clubs</li>
                ...
                <div class="row">
                    <div class="col-xl-6 d-flex">
                        ...
                        <div class="card flex-fill student-space comman-shadow">
                            <div class="card-header d-flex align-items-center">
                                <h5 class="card-title">Star Members</h5>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="profile.html">
                                                        <img class="rounded-circle"
                                                            src="assets/img/Efrat.JPG" width="25"
                                                            alt="Star Students">
                                                        Jolie Hoskins
                                                    </a>
                                                </td>
                    ...
                    <div class="col-xl-6 d-flex">
                        ...
                        <div class="card flex-fill comman-shadow">
                            <div class="card-header d-flex align-items-center">
                                <h5 class="card-title ">Club Activity </h5>
                                <ul class="chart-list-out student-ellips">
                                    <li class="star-menus"><a href="javascript:;"><i class="fas fa-ellipsis-v"></i></a>
                                    </li>
                                </ul>
            ...
            <footer>
                <p>Copyright © 2024 Team ELEVENXI</p>
            </footer>
        </div>
    </div>
