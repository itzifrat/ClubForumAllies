...
<div class="form-outline mb-4">
  ...
  <input type="email" id="form1Example13" class="form-control form-control-lg py-3" name="username" autocomplete="off" 
         placeholder="enter your e-mail" style="border-radius:25px ;" 
         pattern="[a-zA-Z0-9._%+-]+@bscse\.uiu\.ac\.bd" 
         title="Please enter a valid email with the domain bscse.uiu.ac.bd" required />
</div>
